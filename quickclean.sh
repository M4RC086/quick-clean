...
CODE=(c appx wasm toml env xml hcl clj json graphql class cpp cs html css js h java kt lua m md pl py jsx sb3 sln swift vb vcxproj xcodeproj yml rb php h hpp r sql php rs)
